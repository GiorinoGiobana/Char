...
from src.graph_agent_aliyun_glm import app  # noqa: E402
...
def main():
    ...
    parser.add_argument("--out-dir", type=str, default="", help="Output directory (default results/exp1_full_aliyun-glm_YYYYmmdd_HHMMSS）")
        ...
        for idx, item in enumerate(slice_items, start=start):
            ...
            try:
                ...
                try:
                    ...
                    record["error"] = "Workflow execution timeout (180s)"
                    f_out.write(json.dumps(record, ensure_ascii=False) + "\n")
                    f_out.flush()
